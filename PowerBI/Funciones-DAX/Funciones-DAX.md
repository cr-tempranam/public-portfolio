...
Por medio de `COUNT` podemos contar cantidades pero mediante `DISTINCTCOUNT(Table1[Customer Name])` podemos conta cantidades sin repetir elementos. Con esta función se cuenta los clientes únicos que hay en la base de datos y puede determinar el promedio por región general. 
