...
En el archivo [functions-chess.c](https://github.com/cr-tempranam/public-portfolio/blob/HEAD/C/1-functions-chess.c) se crea un *tablero de ajedrez* utilizando funciones.
...
![chess-board](https://github.com/cr-tempranam/public-portfolio/blob/HEAD/C/img/1-chess-board.png)

### 2) Serie de Taylor


En el archivo [functions-calculus.c](https://github.com/cr-tempranam/public-portfolio/blob/HEAD/C/2-functions-calculus.c) bla bla bla